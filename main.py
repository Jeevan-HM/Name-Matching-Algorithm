...
def filter_unicode_characters(data):
    name_in_ascii = unicodedata.normalize(
...
class name_matching(Resource):
    ...
    def get(self, raw_input_name1, raw_input_name2):
        ...
        if levenshtein_distance <= 2 or soundex_representation_name1 == soundex_representation_name2:
            status = True
        ...
        json_response = {
            ...
            "filtered_input": {"name_1": filtered_name_1, "name_2": filtered_name_2},
            "levenshtein_distance": levenshtein_distance,
            "soundex_representaion": {"name_1": soundex_representation_name1, "name_2": soundex_representation_name2},
            "status": status,
            "message": message}
